...
def imprimirTabelaComparativa(x0, y0, xn, h):
    ...
    for x in xr:
        ...
        # if (int(x) == x):
        table.add_row([h, x, y, passo_euler, passo_richar, passo_euler_melhorado, passo_heun, passo_nystrom, passo_runge, erro_euler, erro_richar, erro_euler_melhorado, erro_heun, erro_nystrom, erro_runge])
